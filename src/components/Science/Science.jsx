  ...
  return (
    <section className="science">
      <div className="science__content">
        <span className="science__subtitle">The Science</span>
        <h2 className="science__title">
          Neuroplasticity: The Science of Change
        </h2>
        <p className="science__text">
          Your brain is a living network that evolves based on where you direct
          your energy. Repetition strengthens the pathways that shape who you
          become.
        </p>
